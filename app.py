...
def main():
    ...
    - You will be given 20 seconds to complete as many push-ups as you can, and based on your results, the program will provide an AI-generated plan of action that will help you further your workout goals.
    """)
    ...
    if use_webcam:
        ...
        st.write("Time's up! Workout session ended.")
